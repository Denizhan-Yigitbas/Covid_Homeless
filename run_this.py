...
class FireCLI():
    def national_financial_analysis(self, people_per_room, num_employees_per_10_rooms, min_wage_inflation_percentage):
        ...
        print("Assuming hotels house " + str(people_per_room) +
              ...
              "and inflate the minimum wage for their state by "
              + str(min_wage_inflation_percentage * 100 )+ "% for each employee: \n")
        
        print("The total durational cost and "
              "percent of the passed 2 trillion dollar stimulus bill would be as follows: \n")
        
        print("Housing for 1 Night Cost: ${:,.2f} --> Percentage of stimulus bill {:3.4f}%"
              .format(sum_1, sum_1/2000000000000*100.0))

        print("Housing for 15 Nights Cost: ${:,.2f} --> Percentage of stimulus bill {:3.4f}%"
              .format(sum_15, sum_15 / 2000000000000 * 100.0))

        print("Housing for 30 Nights Cost: ${:,.2f} --> Percentage of stimulus bill {:3.4f}%"
              .format(sum_30, sum_30 / 2000000000000 * 100.0))

        print("Housing for 45 Nights Cost: ${:,.2f} --> Percentage of stimulus bill {:3.4f}%"
              .format(sum_45, sum_45 / 2000000000000 * 100.0))

        print("Housing for 60 Nights Cost: ${:,.2f} --> Percentage of stimulus bill {:3.4f}%"

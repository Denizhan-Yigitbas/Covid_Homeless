...
(The following results can be calculated with custom inputs outline in the [Reproducibility](#Reproduce-Financial-Analysis with-User-Defined-Inputs”) section)<br>
